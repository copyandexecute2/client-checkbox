package net.space.client.gui.elements;

import java.util.function.*;
import java.awt.*;

import net.space.client.Client;
import net.space.client.gui.utils.GLRectUtils;
import net.space.client.gui.utils.GuiUtils;
