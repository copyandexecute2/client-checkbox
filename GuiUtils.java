package net.space.client.gui.utils;
...
public class GuiUtils extends GLUtils
{
    ...
    public static void drawLine2D(double x1, double y1, double x2, double y2, float width, int a) {
        enableRender2D();
    ...
    public void buttonStressSlider(boolean hovered, int lenght, int xPosition, int yPosition, float sliderValue, int width, int height, int color)
    {
        int h = 0;
        int h2 = 20;
        ...
        if (hovered)
        {
            this.drawHorizontalLine(xPosition + (width / 2),
                    xPosition + (width / 2) + lenght,
                    yPosition - h, color);
            this.drawHorizontalLine(xPosition + (width / 2),
                    xPosition + (width / 2) - lenght,
                    yPosition - h, color);
            ...
            this.drawHorizontalLine(xPosition + (width / 2),
                    xPosition + (width / 2) + lenght,
                    yPosition + h2, color);
            this.drawHorizontalLine(xPosition + (int)(sliderValue * (float)(width - 7)),
                    xPosition + (int)(sliderValue * (float)(width - 8)) + 7, //9 - Szerokosc lini
                    yPosition - h, Color.WHITE.getRGB());
            this.drawHorizontalLine(xPosition + (int)(sliderValue * (float)(width - 7)),
                    xPosition + (int)(sliderValue * (float)(width - 8)) + 7, //9 - Szerokosc lini
                    yPosition + h2, Color.WHITE.getRGB());
        }
        else
        {
            if (lenght > 0)
