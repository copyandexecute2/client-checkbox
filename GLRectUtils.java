...
import net.space.client.utils.MathUtil;
...
public class GLRectUtils extends FontUtils
{
    ...
    public static void drawRoundedRect2(final float nameInt1, final float nameInt2, final float nameInt3, final float nameInt4, final float radius, final int color) {
        final float f1 = (color >> 24 & 0xFF) / 255.0f;
        final float f2 = (color >> 16 & 0xFF) / 255.0f;
        final float f3 = (color >> 8 & 0xFF) / 255.0f;
        final float f4 = (color & 0xFF) / 255.0f;
        GlStateManager.color(f2, f3, f4, f1);
        drawRoundedRect2(nameInt1, nameInt2, nameInt3, nameInt4, radius);
    }

    public static void drawRoundedRect2(final float nameFloat1, final float nameFloat2, final float nameFloat3, final float nameFloat4, final float nameFloat5) {
        final int i = 18;
        final float f1 = 90.0f / i;
        GlStateManager.pushMatrix();
        GlStateManager.disableTexture2D();
